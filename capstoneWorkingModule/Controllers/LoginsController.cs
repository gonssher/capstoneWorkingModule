    ...
    public class LoginsController : Controller
    {
        ...
        public async Task<IActionResult> Login([Bind("Id,Email")] Login login, [Bind("Password")] String password)
        {
            if (ModelState.IsValid)
            {
                ...
                List<Customer> customers = (from u in _context.Customers where u.Email.Equals(login.Email) && u.Password.Equals(password) select u).ToList();
                ...
                if (customers.Count == 1)
                {
                    ...
                    if (customer.IsCompletedReg)
                    {
                        ...
                        return RedirectToAction("CompleteRegistration", "Customers", new { @id = customer.CustId});
                    }
                }
                else {
